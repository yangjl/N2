...
\author{Jinliang Yang, David O’Donnell, Alan Bennett and Jeffrey Ross-Ibarra}
...
\begin{description}
\begin{singlespace}
\item [{Author's~names~with~initials:}] \noindent Jinliang Yang, JY; David O’Donnell, DOD; Alan Bennett, AB; and Jeffrey Ross-Ibarra, JRI.
\item [{Postal~address~for~all~authors:}] \noindent Department of Plant Sciences, 
University of California, Davis, CA 95616, USA
\item [{Keywords:}] \noindent \emph{Zea mays}, biological nitrogen fixation, landrace.
\item [{Corresponding~author:}] \noindent Jeffrey Ross-Ibarra\\
...
\item [{Running~Title:}] \noindent The Origin of Biological Nitrogen Fixation
\end{singlespace}
