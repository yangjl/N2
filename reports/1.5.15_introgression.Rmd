...
```
And then run `fastPHASE` to do the haplotype phasing with [HMM](http://statweb.stanford.edu/~nzhang/Stat366/Lecture5.pdf).  
```
cd /largedata/fphase
fastPHASE -oMex -S1234 mex_120.fp 
fastPHASE -oParv -S1234 parv_
fastPHASE -oLand -S1234 land_
```
# 
