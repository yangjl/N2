    ...
    for(geni in gen){
        ...
        for(chri in 1:10){
            ...
            hapmixPar(lambda=geni, parfile= parfileid, 
                      ...
                      admixsnp= paste0("toton34_chr", chri, ".snpinfo"), admixgeno= paste0("toton34_chr", chri, ".out"), 
                      admixind= paste0("toton34_chr", chri, ".ind"), 
                      ref1label="MEX", ref2label="MZ",
                      rates= paste0("toton34_chr", chri, ".rate"), admixlabel="TOTON", 
                      chr= chri, outdir= "T34OUT", pwd=pwd,
                      mode="LOCAL_ANC") 
...
##########################################
run_hapmix(gen=1610, pwd="largedata/hapmixrun", slurmsh_name="slurm-scripts/run_hm34.sh")
