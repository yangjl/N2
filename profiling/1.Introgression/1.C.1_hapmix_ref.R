...
for(chri in 1:10){
    fp <- read_fastphase(fileName = paste0("largedata/fphase/land_94_chr", chri, "_hapguess_switch.out"), chrnum= chri)
    out <- traslate2hapmix(fp = fp, startcol=8, outfile= paste0("largedata/hapmixrun/maizeland94_chr", chri, ".out"),
